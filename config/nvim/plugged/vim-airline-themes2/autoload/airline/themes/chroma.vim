...
" The chroma.vim theme:
let s:airline_a_normal   = [ '#202020' , '#80ff80' , 17  , 190 ]
let s:airline_b_normal   = [ '#408040' , '#404040' , 255 , 238 ]
let s:airline_c_normal   = [ '#80ff80' , '#202020' , 85  , 234 ]
...
" let g:airline#themes#chroma#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#chroma#palette.normal = {
...
" applied after g:airline#themes#chroma#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#chroma#palette.normal_modified = {
      \ 'airline_c': [ '#404040' , '#408040' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_insert = [ '#202020' , '#8080ff' , 17  , 45  ]
let s:airline_b_insert = [ '#404080' , '#404040' , 255 , 27  ]
let s:airline_c_insert = [ '#8080ff' , '#202020' , 15  , 17  ]
...
let g:airline#themes#chroma#palette.insert_modified = {
      \ 'airline_c': [ '#404040' , '#404080' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#chroma#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#ff8000' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }

let g:airline#themes#chroma#palette.terminal = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)

let g:airline#themes#chroma#palette.replace = copy(g:airline#themes#chroma#palette.insert)
let g:airline#themes#chroma#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#ff0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#chroma#palette.replace_modified = g:airline#themes#chroma#palette.insert_modified


let s:airline_a_visual = [ '#202020' , '#ff8080' , 232 , 214 ]
let s:airline_b_visual = [ '#804040' , '#404040' , 232 , 202 ]
let s:airline_c_visual = [ '#ff8080' , '#202020' , 15  , 52  ]
...
let g:airline#themes#chroma#palette.visual_modified = {
      \ 'airline_c': [ '#404040' , '#804040' , 255     , 53      , ''     ] ,
      \ }


let s:airline_a_inactive = [ '#404040' , '#101010' , 239 , 234 , '' ]
let s:airline_b_inactive = [ '#404040' , '#202020' , 239 , 235 , '' ]
let s:airline_c_inactive = [ '#404040' , '#303030' , 239 , 236 , '' ]
...
let s:airline_a_commandline = [ '#202020' , '#ffff80' , 17  , 40 ]
let s:airline_b_commandline = [ '#808040' , '#404040' , 255 , 238 ]
let s:airline_c_commandline = [ '#ffff80' , '#202020' , 85  , 234 ]
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#chroma#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        \ [ '#202020' , '#ff80ff' , 189 , 55  , ''     ],
        \ [ '#804080' , '#404040' , 231 , 98  , ''     ],
        \ [ '#ff80ff' , '#202020' , 55  , 231 , 'bold' ])
endif
